...
class WorkerSettings:
    ...
    functions = [process_webhook_event, run_payment_reconciliation, expire_vouchers, retry_failed_coa_events, check_router_health, collect_router_metrics, generate_monthly_invoices, handle_trial_expiry, enforce_billing]
    cron_jobs = [
